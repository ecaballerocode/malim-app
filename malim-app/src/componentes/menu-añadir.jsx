...
function MenuAñadir({menuAñadir}){
    ...
    return(
        <div class={`fixed flex justify-center bottom-0 w-full shadow-xl h-64 transform ${menuAñadir ? "translate-y-0": "translate-y-full"} transition-transform duration-300 ease-in-out`}>
            <div className="bg-black text-center h-full w-4/5 border-t-4 border-black rounded-xl opacity-75">
